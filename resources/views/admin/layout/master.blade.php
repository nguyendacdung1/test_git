...
<head>
    ...
    <link href="./public/admin/my_style.css" rel="stylesheet">
</head>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-secondary">
                                    <div class="menu-header-image opacity-5"
                                         style="background-image: url('public/admin/assets/images/dropdown-header/abstract2.jpg');">
{{--
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('public/admin/assets/images/dropdown-header/abstract3.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    <div class="menu-header-image"
                                         style="background-image: url('public/admin/assets/images/dropdown-header/abstract4.jpg');">
                                    </div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true"
                            ...
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('public/admin/assets/images/dropdown-header/city3.jpg');">
                                    </div>
                                                                    ...
                                                                    <h4 class="timeline-title">Something not
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/2.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/3.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/4.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/5.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/9.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/7.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon">
                                                                                    <img src="public/admin/assets/images/avatars/8.jpg"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05"
                                         style="background-image: url('public/admin/assets/images/dropdown-header/city2.jpg');">
                                    </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/author" class="{{ (request()->segment(2)=='author' ? 'mm-active': '')}}">
                                        <i class="metismenu-icon"></i>Author
                                    </a>
                                </li>
                                <li>
                                        ...
                                        <div class="d-none popover-custom-content">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                    <div class="menu-header-image opacity-1"
                                                         style="background-image: url('public/admin/assets/images/dropdown-header/city5.jpg');">
                                                    </div>
                                                    <div class="menu-header-content text-dark">
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    <h4 class="timeline-title">Something not important
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            ...
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/2.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/3.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/4.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/5.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/6.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/7.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="public/admin/assets/images/avatars/8.jpg" alt="">
                                                </div>
                                            </div>
...
<script src="public/admin/assets/scripts/jquery-3.2.1.min.js"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>

<script type="text/javascript" src="./public/admin/assets/scripts/main.js"></script>
<script type="text/javascript" src="./public/admin/assets/scripts/my_script.js"></script>
</body>
