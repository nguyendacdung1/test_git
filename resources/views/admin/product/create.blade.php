                        ...
                        <form method="post" enctype="multipart/form-data" action="admin/product">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select required name="author_id" id="brand_id" class="form-control">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="pages" id="weight"
                                           placeholder="Pages" type="text" class="form-control" value="">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                <label for="pages"
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="pub_year" id="weight"
                                           placeholder="pub_year" type="text" class="form-control" value="">
                                </div>
                            </div>
